...
test.describe('Dashboard Interactions', () => {
  ...
  test('add new course', async ({ page }) => {
    ...
    await page.fill('input[name="courseName"]', 'Test Course One');
    await page.fill('input[name="courseDescription"]', 'This is a description for the Test Course, a course teaching nothing.');
    await page.click('button[type="submit"]');
